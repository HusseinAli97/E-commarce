    ...
    return (
        <>
            ...
            <Modal show={show} centered onHide={handleClose} size='lg' className={`${styles.bg}`} >
                <Container className={`p-0  shadow ${styles.bgCard}`}>
                    <Row className='py-5'>
                            ...
                            <div className="d-flex flex-column w-100 justify-content-center align-items-center">
                                ...
                                <form className={`w-100   `} onSubmit={formik.handleSubmit}>
                                    <Row className='pb-2' >
                                        <Col md={6}>
                                            <FloatingLabel controlId="floatingName" label="Name" className="mb-2">
                                                ...
                                                {formik.errors.name && formik.touched.name ? <Form.Text className="text-danger fw-bold bg-dark  rounded ms-auto d-flex bg-opacity-25">{formik.errors.name}</Form.Text> : null}
                                            </FloatingLabel>
                                        </Col>
                                        <Col md={6}>
                                            <FloatingLabel controlId="floatingEmail" label="Email address" className="mb-2">
                                                ...
                                                {formik.errors.email && formik.touched.email ? <Form.Text className="text-danger fw-bold bg-dark  rounded ms-auto d-block bg-opacity-25">{formik.errors.email}</Form.Text> : null}
                                            </FloatingLabel>
                                        </Col>
                                    </Row>
                                    <Row>
                                        <Col md={6}>
                                            <FloatingLabel controlId="floatingPassword" label="Password" className="mb-2">
                                                ...
                                                {formik.errors.password && formik.touched.password ? <Form.Text className="text-danger fw-bold bg-dark p-1 mt-2 rounded ms-auto d-block bg-opacity-25">{formik.errors.password}</Form.Text> : null}
                                            </FloatingLabel>
                                        </Col>
                                        <Col md={6}>
                                            <FloatingLabel controlId="floatingrePassword" label="Confirm Password" className="mb-2">
                                                ...
                                                {formik.errors.rePassword && formik.touched.rePassword ? <Form.Text className="text-danger fw-bold bg-dark p-1 mt-2 rounded ms-auto d-block bg-opacity-25">{formik.errors.rePassword}</Form.Text> : null}
                                            </FloatingLabel>
                                        </Col>
                                    </Row>
                                    <FloatingLabel controlId="floatingPhone" label="Phone Number" className="mb-2">
                                        ...
                                        {formik.errors.phone && formik.touched.phone ? <Form.Text className="text-danger fw-bold bg-dark p-1 mt-2 rounded ms-auto d-block bg-opacity-25">{formik.errors.phone}</Form.Text> : null}
                                    </FloatingLabel>
